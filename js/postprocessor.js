        ...
        switch(effect) {
            ...
            case "reverse":
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    let audioSequence = channels[c].audioSequenceReference;
            ...
            case "tremolo":
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    for(var i = 0; i < audioSequence.data.length; ++i) {
                        let t = i / sampleRate;
                        let multiplier = (Math.sin(2 * Math.PI * tremoloFrequency * t + 3 * Math.PI / 2) + 1) / 2;
            ...
            case "echo":
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    let delayLineSize = parseInt(delayLineDuration * sampleRate);
                    let delayLine = new Array(delayLineSize).fill(0);

                    // Get the sample data of the channel
                    for(var i = 0; i < audioSequence.data.length; ++i) {
                        // Get the echoed sample from the delay line
                        let delayLineOutput = delayLine[i % delayLineSize];
